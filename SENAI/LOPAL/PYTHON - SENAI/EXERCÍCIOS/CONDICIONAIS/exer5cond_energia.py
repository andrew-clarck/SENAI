...
if kWC <= 500 and IN == "R":
    ...
    preco = 0.65
    VP1 = kWC * preco
    print("Este é o valor que você deve pagar: R$%.2f" % VP1)
elif kWC > 1000 and IN == "R":
    print("Valor de kWh consumido muito alto para o tipo de instalação.")
if kWC <= 2500 and IN == "C":
    preco = 0.55
    VP2 = kWC * preco
    print("Este é o valor que você deve pagar: R$%.2f" % VP2)
elif kWC > 2500 and kWC <= 5000 and IN == "C":
    preco = 0.60
    VP3 = kWC * preco
    print("Este é o valor que você deve pagar: R$%.2f" % VP3)
elif kWC > 5000 and IN == "C":
    print("Valor de kWh consumido muito alto para o tipo de instalação.")
if kWC <= 10000 and IN == "I":
    preco = 0.55
    VP4 = kWC * preco
    print("Este é o valor que você deve pagar: R$%.2f" % VP4)
elif kWC > 10000 and kWC <=15000 and IN == "I":
    preco = 0.60
    VP5 = kWC * preco
    print("Este é o valor que você deve pagar: R$%.2f" % VP5)
