...
function renderizarJogos() {
  ...
  contador.textContent = `Você tem ${lista.length} jogo(s) na sua lista.`
  ...
  lista.forEach(function (jogo, indice) {
    ...
    li.innerHTML = `
      ...
      <div class="meta">Plataforma: ${jogo.plataforma}</div>
...
document.querySelector("#btn-limpar").addEventListener("click", () => {
  const confirmarAcao = confirm("Tem certeza que quer excluir todos os jogos da lista?")
