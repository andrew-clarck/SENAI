...
_Dica: Você também pode usar `node --watch src/server.js` se estiver usando o Node.js v20+ e quiser recarregar o servidor automaticamente após salvar arquivos._
