...
// const pedido1 = new Pedido(12, "Coca-Cola", 2, 12.99);
...
//     constructor(motorista, placa) { //Não é necessário chamar "quantidade", ele já vai ser identificado e fixado em Super
//         super(placa, 5000); //Mantém a capacidade fixa em 5000
...
//     constructor(motorista, eixos, placa) { //Não é necessário chamar os atributos já existentes na classe Pai, basta o Super
//         super(placa, 8000); //Mantém a capacidade fixa em 8000
//         this.motorista = motorista;
//         this.eixos = eixos;
//     }

//     podeTransportar(carga) {
//         if (carga > (this.capacidade * this.eixos)) {
//             return `Impossível transportar esse peso. Capacidade máxima: ${this.capacidade * this.eixos}kg`;
//         }
//         else {
//             return "Pode transportar.";
//         }
...
// const van1 = new Van("Andrew", "ABCDE-123");
// const caminhao1 = new Caminhao("Celso", 3, "FGHIJ-456");
...
//     new GerenteDeLogistica("Daniel", 3000),
//     new OperadorDeEmpilhadeira("Matheus", 2000),
//     new GerenteDeLogistica("Marlon", 5000),
//     new GerenteDeLogistica("Celso", 4000),
//     new OperadorDeEmpilhadeira("Andrew", 1000),
// ]
...
//     } else {
//       return "Valor incorreto. Menor que zero.";
//     }
//   }
